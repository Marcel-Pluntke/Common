...
void loop() {
  ...
  // Überprüfen, ob das Signal innerhalb des gültigen Bereichs liegt
  if (channel2Value < 900 || channel2Value > 2000) {
    // Wenn das Signal außerhalb des gültigen Bereichs ist, in den Neutralgang schalten
    targetForwardPWM = 0;
    targetBackwardPWM = 0;
